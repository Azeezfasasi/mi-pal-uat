 ...
 */
export const sendApplicationConfirmation = async (memberData: MemberData) => {
  const htmlContent = `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <p><strong>Membership Type:</strong> ${memberData.membershipType ? memberData.membershipType.charAt(0).toUpperCase() + memberData.membershipType.slice(1) : 'Not specified'}</p>
          </div>
  ...
  return sendEmail({
    ...
    htmlContent,
    textContent: 'Thank you for submitting your membership application to CANAN USA!',
  });
};
 ...
 */
export const sendStatusChangeNotification = async (memberData: MemberData, newStatus: string) => {
  ...
  return sendEmail({
    ...
    htmlContent,
    textContent: `Your application status has been updated to ${statusLabels[newStatus]}`,
  });
};
 ...
 */
export const sendAdminReply = async (memberData: MemberData) => {
  const htmlContent = `
    <!DOCTYPE html>
    <html>
    <head>
  ...
  return sendEmail({
    ...
    htmlContent,
    textContent: 'We have a message for you regarding your membership application',
  });
};
 ...
 */
export const sendAdminNotification = async (memberData: MemberData) => {
  const htmlContent = `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <p><strong>Email:</strong> ${memberData.email}</p>
            <p><strong>Phone:</strong> ${memberData.phone}</p>
            <p><strong>Date of Birth:</strong> ${memberData.dateOfBirth ? new Date(memberData.dateOfBirth).toLocaleDateString() : 'Not specified'}</p>
          </div>
          ...
          <div class="info-box">
            ...
            <p><strong>Membership Type:</strong> ${memberData.membershipType ? memberData.membershipType.charAt(0).toUpperCase() + memberData.membershipType.slice(1) : 'Not specified'}</p>
            <p><strong>Interests:</strong> ${memberData.interests && memberData.interests.length > 0 ? memberData.interests.join(', ') : 'Not specified'}</p>
          ...
          <div class="info-box">
            ...
            <p><strong>How They Heard:</strong> ${memberData.howHeardAbout ? memberData.howHeardAbout.replace(/_/g, ' ').toUpperCase() : 'Not specified'}</p>
          </div>
  ...
  return sendEmail({
    ...
    htmlContent,
    textContent: `New membership application from ${memberData.firstName} ${memberData.lastName}`,
  });
};
 ...
 */
export const sendAdminUpdateNotification = async (memberData: MemberData, updateType: string) => {
  const updateLabels: { [key: string]: string } = {
  ...
  return sendEmail({
    ...
    htmlContent,
    textContent: `Application update notification for ${memberData.firstName} ${memberData.lastName}`,
  });
};
